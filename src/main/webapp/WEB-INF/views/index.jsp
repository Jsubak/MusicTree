...
<body>
	...
	<div class="content">
		...
		<div class="chartBox">
			...
			<div class="musicChart">
				<div class="Ctitle">
					...
					<div class="moreBtn">
						더보기
						<img src="${path}/static/img/arrow_right@2x.png" class="playBtn" />
					</div>
				</div>
				<div class="chartList">
					<div class="listItem">
						<div class="rank">1</div>
						<div class="musicTitle">123123</div>
						<div class="singer">zxcv</div>
		...
		<div class="videoChart">
			...
			<div class="chartList">
				<div class="listItem">
					<iframe src="https://www.youtube.com/embed/IrIAWad_ORA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
				<div class="listItem">
					<iframe src="https://www.youtube.com/embed/IrIAWad_ORA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
		...
		<div class="bottomMenu">
			...
			<div class="customerCenter">
				<div class="ccTitle">CUSTOMER CENTER</div>
